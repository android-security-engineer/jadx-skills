...
public final class CommandDispatch {
	...
	public static Object run(String command, Map<String, Object> args, JadxDecompiler decompiler) throws Exception {
		switch (command) {
			...
			case "react-native-analysis":
				return applyAndRun(new ReactNativeAnalysisCommand(), args, decompiler);
			case "dotnet-analysis":
				return applyAndRun(new DotnetAnalysisCommand(), args, decompiler);
			case "cordova-analysis":
				return applyAndRun(new CordovaAnalysisCommand(), args, decompiler);
